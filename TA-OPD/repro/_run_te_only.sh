...
export C_INCLUDE_PATH="${NVIDIA_PKG}/cusparse/include:${NVIDIA_PKG}/cublas/include:${NVIDIA_PKG}/cufft/include:${NVIDIA_PKG}/cusolver/include:${NVIDIA_PKG}/curand/include:${NVIDIA_PKG}/cudnn/include:${NVIDIA_PKG}/cuda_runtime/include:${NVIDIA_PKG}/nvtx/include:${NVIDIA_PKG}/cuda_nvrtc/include:${C_INCLUDE_PATH:-}"
export CPLUS_INCLUDE_PATH="${C_INCLUDE_PATH}"
export LIBRARY_PATH="${NVIDIA_PKG}/cusparse/lib:${NVIDIA_PKG}/cublas/lib:${NVIDIA_PKG}/cufft/lib:${NVIDIA_PKG}/cusolver/lib:${NVIDIA_PKG}/curand/lib:${NVIDIA_PKG}/cudnn/lib:${NVIDIA_PKG}/cuda_runtime/lib:${NVIDIA_PKG}/nvtx/lib:${NVIDIA_PKG}/cuda_nvrtc/lib:${LIBRARY_PATH:-}"
