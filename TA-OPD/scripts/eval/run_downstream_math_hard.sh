...
export PYTHONPATH=/path/to/python_deps/lmeval_math:${PYTHONPATH:-}

EVAL_BIN=lm-eval
PY_BIN=python3
TASK=${TASK:-leaderboard_math_hard}
BATCH_SIZE=${BATCH_SIZE:-4}
OUT_ROOT=/path/to/outputs/slime_opd/analysis/downstream_smoke_20260515/math_hard
SUMMARY_SCRIPT="${SUMMARY_SCRIPT:-tools/summarize_math_hard.py}"
