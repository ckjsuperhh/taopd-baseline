...
GPU_ID="${GPU_ID:-1}"
RUN_DIR="${RUN_DIR:-/path/to/outputs/slime_opd/storyline_20260513/downstream_smoke_20260515/aime24_25_capped4096}"
...
root = Path("/path/to/outputs/slime_opd/storyline_20260513/downstream_smoke_20260515/aime24_25_capped4096")
rows = []
