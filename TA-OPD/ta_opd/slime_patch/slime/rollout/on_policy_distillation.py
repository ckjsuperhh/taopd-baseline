...
from .tip_compat import maybe_add_teacher_token_ids_request, maybe_add_topk_request, process_tip_compat_metrics
...
async def reward_func(args, sample, **kwargs):
    ...
    maybe_add_teacher_token_ids_request(args, payload, sample)
...
def post_process_rewards(args, samples: list[Sample], **kwargs):
    ...
    process_tip_compat_metrics(args, samples, teacher_log_probs, raw_rewards)
